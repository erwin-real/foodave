...
<div class="body-left d-none d-md-none d-lg-block d-xl-block">
    <div class="sidenav">
        <ul class="list-group">
            ...
            @if(Auth::user()->type == 'admin')
                <li class="list-group-item {{ request()->is('expenses') || request()->is('expenses/*') || request()->is('guide/expenses') ? 'active' : '' }}">
                    <a href="/expenses">
                        <div class="icon">
                    ...
                    <div class="arrow d-none {{ request()->is('expenses') || request()->is('expenses/*') || request()->is('guide/expenses') ? 'd-md-none d-lg-block d-xl-block' : '' }}"></div>
                </li>
